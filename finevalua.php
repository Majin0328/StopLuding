                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            ...
                            <div class="fs-3 fw-light text-muted ">
                                <a class="display-5 fw-bolder nav-link text-gradient d-inline" href="evaluar.php">Completado</a>
                                <br>
                                <p>Felicidades, haz completado la prueba</p>
                                <a href="contenido.php">
                                <button href="indexprincipal.php" style="background-color: white; color: black; border-radius: 4px; padding: 10px 20px; border: none;">Volver al menu</button>
                                </a>
