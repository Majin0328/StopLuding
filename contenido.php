    ...
    <div class="chat-container">
     <div class="chat-row right">
        <div style="display: flex; flex-direction: column; padding: 10px;">
          <div class="chat-bubble-big right"> Nosotros te ayudamos a determinar que es.</div>
                </div>
                    <img src="images\LUDI PNG\ludi-exited.png"  alt="20%" width="20%">
                 </div>
            </div>
        </div>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            ...
                            <div class="fs-1 fw-light text-muted"><a
                                    class="display-5 fw-bolder nav-link text-gradient d-inline"
                                    href="videos.php">Videos</a>
                                <br>
                                <div class="fs-3 fw-light text-muted ">
                                <p>Consulta los videos que tenemos para ti</p>
                                </div>

           <div class="container d-flex justify-content-center align-items-center" style="height: 33vh;">
<div class="chat-container">
 <div class="chat-row ">
                <img src="images\LUDI PNG\ludi-flow.png"  alt="20%" width="20%">
      <div class="chat-bubble-big"> Tambien puedes aprender haciendo cosas cool, como ver a BaityBait.</div>
        </div>
    </div>
                            </div>
                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            ...
                            <div class="fs-1 fw-light text-muted"><a
                                ...
                                <br>
                                <div class="fs-3 fw-light text-muted ">
                                <p>Aqui podras consultar informacion adicional</p>
                                </div>
    ...
    <div class="chat-container">
     <div class="chat-row right">
        <div style="display: flex; flex-direction: column; padding: 10px;">
          <div class="chat-bubble-big right"> Siempre viene bien leer algo interesante.</div>
                </div>
