                        ...
                        <div class="text-center text-xxl-start">
                            ...
                            <div class="fs-1 fw-light text-muted ">
                                <a class="display-5 fw-bolder nav-link text-gradient d-inline"
                                    href="juegos.php">Identifica el problema</a>
                                <br>
                                <div class="fs-3 fw-light text-muted ">
                                <p>¿Tienes las sospechas de que igual y estas desarrollando un problema? Nosotros te ayudamos a determinar que es.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            ...
                            <div class="fs-1 fw-light text-muted"><a
                                ...
                                <br>
                                <div class="fs-3 fw-light text-muted ">
                                <p>Consulta los videos que tenemos para ti para que puedas comprender todo sobre la ludopatia</p>
                                </div>
                            </div>
